...
void PrimeFactorizationWithMultipleThreads::_thread_func(PrimeFactorizationWithMultipleThreads *p, uint64_t p_min, uint64_t p_max)
{
    p->check_range(p_min, p_max);
}
